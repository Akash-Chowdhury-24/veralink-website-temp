      ...
      <div className="blog-detail-wrapper-main">
        ...
        <div className="blog-detail-container">
          ...
          <div className="blog-content">
            <h2>SHOUTOUT MIAMI – Meet VeraLink’s Founder & CTO</h2>
            <p className="meta">September 3, 2024 | Blog Articles, News</p>
            <img
              src="/blog-detail2-image.png"
              alt="blog"
            ...
            <div className="sidebar-section">
              ...
              <div className="recent-posts">
                <div className="post-card">
                  <img src="/blog-detail2-right.png" alt="thumb" />
                  <div>
                    <Link to="/blog-detail1">JBDC – Programme Magazine Cohort 4</Link>
                ...
                <div className="post-card">
                  ...
                  <div>
                    <Link to="#">Jamaica Observer features VeraLink</Link>
                    <span>August 23, 2024</span>
                  </div>
                </div>
                <div className="post-card">
                  <img src="/blog-detail2-right-img1.png" alt="thumb" />
                  <div>
                    <Link to="/blog-detail3">The Future of IT in 2024</Link>
                    <br />
                    <span>August 23, 2024</span>
                  </div>
                </div>
